...
OUTFILE is the only required subcommand. Specify the system file to be written as a string file name or a file handle (see [File Handles](File-Handles.md)). 
...
`COMPRESSED` is the default compression level. The SET command (see [SET](SET.md)) can change this default. 
