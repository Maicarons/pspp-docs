...
This is a binary format for real numbers. By default it reads and writes the host machine’s floating-point format, but SET RRB may be used to select an alternate floating-point format for reading (see [SET RRB](SET.md#SET-RRB)) and SET WRB, similarly, for writing (see [SET WRB](SET.md#SET-WRB)). 
