...
To associate custom attributes with the entire active dataset, instead of with particular variables, use `DATAFILE ATTRIBUTE` (see [DATAFILE ATTRIBUTE](DATAFILE-ATTRIBUTE.md)) instead. 
