...
The commas or periods divide string into four fields, called the _negative prefix_ , _prefix_ , _suffix_ , and _negative suffix_ , respectively. The prefix and suffix are added to output whenever space is available. The negative prefix and negative suffix are always added to a negative number when the output includes a nonzero digit. 
