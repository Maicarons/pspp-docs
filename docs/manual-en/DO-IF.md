...
When `DO IF` or `ELSE IF` is specified following `TEMPORARY` (see [TEMPORARY](TEMPORARY.md)), the `LAG` function may not be used (see [LAG](Miscellaneous-Functions.md#LAG)).
