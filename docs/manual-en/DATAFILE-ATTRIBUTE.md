...
To associate custom attributes with particular variables, instead of with the entire active dataset, use `VARIABLE ATTRIBUTE` (see [VARIABLE ATTRIBUTE](VARIABLE-ATTRIBUTE.md)) instead. 
